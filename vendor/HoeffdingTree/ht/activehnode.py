...
from gaussianconditionalsufficientstats import GaussianConditionalSufficientStats
from nominalconditionalsufficientstats import NominalConditionalSufficientStats
